 ...
 *
 *   node design/system/_build_bundle.mjs
 *
 ...
 * JSX transform — resolved from quotos-app's node_modules; no dependency
 * of its own.
 */
...
const { transformSync } = createRequire(join(here, "../../quotos-app/package.json"))("esbuild");
