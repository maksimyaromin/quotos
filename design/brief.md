...
1. The product **scans the machine** and reports what it found — "found two
   subscriptions" — with the option to add them.
...
- Providers other than the first one — but the interface must not assume a
