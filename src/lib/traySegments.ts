...
/** v4 docs/design/NOTES.md §1: bar/number colour mirrors the row's own per-window
...
/** v4 docs/design/NOTES.md §1/§4: one segment per pinned *window*, in panel order
 ...
 * nothing — never "!", never "…" (docs/design/NOTES.md's "либо цифра, либо
 * ничего"). */
...
/** v4 docs/design/NOTES.md §1: the bare glyph's own arc — always filled to the
