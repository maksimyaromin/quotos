Use `MenuBarTile` to represent Quotos in the macOS menu bar: the quota-ring glyph plus any pinned subscriptions' figures. Stays monochrome; a figure gains an amber/red tint or a small warning mark only when it needs attention, whether behind, broken, or nearly spent.
